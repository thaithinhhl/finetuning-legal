...
## Pha 2 — baseline BF16 LoRA trên H200

1. Base: `Qwen/Qwen2.5-7B-Instruct` (thay đúng checkpoint nếu model đầu vào khác).
2. Nạp base weights ở BF16, không quantization; LoRA rank 32 trên các linear projection của Qwen.
3. Train 3 epochs, effective batch size 32/GPU, learning rate `1e-4`, cosine schedule, warmup 3%.
...
- Overfit: thử 1–2 epochs, giảm LR xuống `5e-5`, hoặc tăng LoRA dropout.
- Underfit: thử rank 64, thêm epoch, hoặc tăng dữ liệu chất lượng cao.
